...
export function AppraiserDetails() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50/50 to-purple-50/30 dark:from-slate-950 dark:via-blue-950/50 dark:to-indigo-950/30" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,_rgba(99,102,241,0.1),_transparent_50%),_radial-gradient(circle_at_80%_80%,_rgba(59,130,246,0.08),_transparent_50%),_radial-gradient(circle_at_40%_20%,_rgba(139,92,246,0.06),_transparent_40%)] animate-pulse" style={{ animationDuration: '8s' }} />
      ...
      <div className="relative z-10">
        ...
        <div className="min-h-[calc(100vh-120px)]">
          <div className="h-full bg-gradient-to-br from-white/95 via-white/90 to-blue-50/80 backdrop-blur-2xl dark:from-slate-900/95 dark:via-slate-900/90 dark:to-blue-950/80">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 px-8 py-8">
                ...
                <div className="relative flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 text-sm text-blue-100">
                      ...
                      <span className="text-blue-100/80">— Establish appraiser identity</span>
                    </div>
                  </div>
                </div>
              </div>
